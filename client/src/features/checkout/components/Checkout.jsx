...
export const Checkout = () => {
    ...
    const orderDiscountPrice=cartItems.reduce((acc,item)=>(item.product.discountPrice*item.quantity)+acc,0)
    ...
    const handleCreateOrder=()=>{
        const order={user:loggedInUser._id,item:cartItems,address:selectedAddress,paymentMode:selectedPaymentMethod,total:orderDiscountPrice+SHIPPING}
